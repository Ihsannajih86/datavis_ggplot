...
ggplot(lizards, aes(x = total_length, y = weight)) +
  geom_jitter(color = "pink", size = 3, alpha = 0.6, width = 0.5, height = 0.5) +  # Use geom_jitter for spreading points
  labs(title = "Plot Titik - Lizard Data", x = "Total Length", y = "Weight") +
  ...
  theme(
    ...
    axis.text = element_text(color = "red")  # Axis text with red color
  )
